...
use cosmwasm_std::{
    ...
    IbcPacketReceiveMsg, IbcPacketTimeoutMsg, IbcReceiveResponse, StdResult, StdError,
};
use cw_storage_plus::Map;
use thiserror::Error;

use crate::{ack::{make_ack_fail, make_ack_success}, error::ContractError};

// Note the "--channel-version" use when running hermes or similar relayer
pub const IBC_VERSION: &str = "counter-contract-1";

// ----------------------------- State, messages, errors etc... TBD: to be moved! ------------------------------ //
